	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="page-header">
				  <h3>Registro de Retiro  <small> (${session.empresa})</small>
		...
		<div class="row ">
			...
			<div class="col-md-8 col-md-offset-2">
				...
				<g:form class="form-horizontal" action="saveRetiro" >	

					<div class="panel panel-warning">
						<div class="panel-heading">Retiro  ( Periodo:${session.periodoTesoreria})</div>

...
<head>
	...
	<title>Polizas: ${satPolizasLogInstance.id}</title>
</head>
<body>
	<div class="container">
		...
		<div class="row form-panel">
			<div class="col-md-12">
				<div class="panel ${satPolizasLogInstance.acuse?'panel-success':'panel-primary'}">
					<!-- Default panel contents -->
  					<div class="panel-heading">
  						Registro de polizas  contables  (${satPolizasLogInstance.nombre})
  					</div>
  					...
  					<div class="panel-footer">
  						<div class="btn-group">
  							...
  							<g:link class="btn btn-default btn-sm" action="index" >
								<i class="fa fa-step-backward"></i> Polizas</span>
							</g:link>
  						
  							<g:link class="btn btn-default btn-sm" action="mostrarXml" resource="${satPolizasLogInstance}">Ver XML</g:link>
  							
							<g:link class="btn btn-default btn-sm" action="descargarXml" resource="${satPolizasLogInstance}">
							...
							<g:if test="${satPolizasLogInstance.acuse}">
								<g:link  action="descargarAcuseXml" 
									id="${satPolizasLogInstance.id}"
									class="btn btn-default btn-sm" >
									<span class="glyphicon glyphicon-cloud-download"></span> Descargar acuse
								</g:link>
								%{-- <g:link class="btn btn-default btn-sm" action="mostrarAcuseXml" resource="${satPolizasLogInstance}">
									Ver Acuse
								</g:link> --}%
							</g:if>

							<g:if test="${satPolizasLogInstance.acuseDeAceptacion}">
								<g:link class="btn btn-default btn-sm" action="descargarAcuseDeAceptacion" resource="${satPolizasLogInstance}">
							...
							<g:link  action="delete" class="btn btn-default btn-sm"  
										onclick="return confirm('Eliminar Balanza: ${satPolizasLogInstance.id }?');" id="${satPolizasLogInstance.id }">

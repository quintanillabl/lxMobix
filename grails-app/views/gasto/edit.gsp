				  		...
				  		<div class="panel-body">
							...
							<f:with bean="${gastoInstance}">
								...
								<div class="col-sm-4" id="totalesPanel">
									...
									<f:display property="retensionIva"  cols="col-sm-8" colsLabel="col-sm-4" widget="money"/>
									<f:display property="retensionIsr"  cols="col-sm-8" colsLabel="col-sm-4" widget="money"/>
	...
	<div class="modal fade" id="uploadFileDialog" tabindex="-1">
		<div class="modal-dialog ">
			<div class="modal-content">
				...
				<g:uploadForm class="form" action="asignarCfdi" id="${gastoInstance?.id}">

		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="alert alert-info">
					<h3> 
						<p>Catálogo de cuentas de banco <small>${session.empresa}</small></p>
					</h3>
		...
		<div class="row">
			<div class="col-md-12">
				<table id="grid" class="table table-striped table-bordered table-condensed">
					...
					<tbody>
						<g:each in="${cuentaBancariaInstanceList}" var="row">
							<tr id="${row.id}">
								<td >
									<g:link  action="show" id="${row.id}">
										${fieldValue(bean:row,field:"banco.nombre")}
									</g:link>
								</td>
								<td>
									<g:link  action="show" id="${row.id}">
				...
				<div class="pagination">
					<g:paginate total="${cuentaBancariaInstanceCount ?: 0}"/>
				</div>
			</div>
		</div> <!-- end .row 2 -->

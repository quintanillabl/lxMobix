...
<div class="panel panel-primary">
	<div class="panel-heading">Concepto de póliza ${polizaInstance.tipo} ${polizaInstance.folio} (${polizaInstance.mes} - ${polizaInstance.ejercicio})</div>
	...
	<div class="panel-body ">
		...
		<g:form name="updateForm" action="update" class="form-horizontal" method="PUT" id="${polizaDetInstance.id}">	
